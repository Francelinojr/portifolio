...
/** Static experience data array to allow easy expansion */
          ...
          >
            ...
            >
              <div className="flex-shrink-0">
                <div className="w-16 h-16 rounded-xl overflow-hidden border border-slate-100 dark:border-slate-800 bg-white p-1 flex items-center justify-center">
                  <img
                    src={exp.image}
