...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative h-[100dvh] overflow-hidden flex flex-col items-center justify-center py-8 sm:py-12 px-4 bg-white dark:bg-transparent transition-colors duration-300">
      <motion.div
