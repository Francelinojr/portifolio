        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <a href="/curriculo.pdf" target="_blank" className="text-slate-600 dark:text-slate-400 hover:text-blue-600 text-xs font-medium transition-colors">Currículo</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="https://github.com/Francelinojr" target="_blank" className="flex items-center gap-2.5 text-slate-600 dark:text-slate-400 hover:text-blue-600 transition-colors">
                  <Github size={14} />
                  <span className="text-xs font-medium">GitHub</span>
                </a>
              </li>
              <li>
                <a href="https://www.linkedin.com/in/francelino-júnior/" target="_blank" className="flex items-center gap-2.5 text-slate-600 dark:text-slate-400 hover:text-blue-600 transition-colors">
                  <Linkedin size={14} />
